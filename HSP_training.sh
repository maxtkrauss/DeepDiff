...
#SBATCH --job-name=training_job_20250812_0.1gan_single_hs_l1
#SBATCH --output=training_job_20250812_0.1gan_single_hs_l1%j.log
...
python train.py --dataroot /scratch/general/nfs1/u1528328/img_dir/mkrauss/banknotes --name hyperspectral_banknotes_8-14 --checkpoints_dir /scratch/general/nfs1/u1528328/model_dir/W-NET_models/checkpoints_hyperspectral_banknotes_8-14 --model pix2pix --input_nc 1 --output_nc 106 --n_epochs 10 --n_epochs_decay 10 --save_epoch_freq 5 --netG unet_1024 --netG_reps 2 --netD_mult 0 --polarization 0

python test.py --dataroot /scratch/general/nfs1/u1528328/img_dir/mkrauss/banknotes --name hyperspectral_banknotes_8-14 --checkpoints_dir /scratch/general/nfs1/u1528328/model_dir/W-NET_models/checkpoints_hyperspectral_banknotes_8-14 --model pix2pix --input_nc 1 --output_nc 106 --netG unet_1024 --netG_reps 2 --netD_mult 0 --polarization 0
